...
export default function SupplierListPage() {
    ...
    return (
        <div className="relative bg-white dark:bg-gray-900 text-black dark:text-white  md:mx-auto md:w-md">
            ...
            <Link href={'/suppliers/create'} className="sticky left-[365px] bottom-[80px] w-12 h-12 bg-black dark:bg-white text-white dark:text-black rounded-full flex items-center justify-center hover:bg-gray-800 dark:hover:bg-gray-200 shadow-xl">
